...
function PopulateInformationSheet() {
  ...
  SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange(lastRow, 3).setValue("Completed");
  SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange(lastRow, 4).setValue("Open");
  SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange(lastRow, 5).setValue("Owed");

  // format headers
  SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange(SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getLastRow(), 2, 1, 4)
  .setFontWeight('bold')
  .setFontColor('#000000')
...
function PopulateCharacterMetrics(character) {
  ...
  if(temp.length > 0){
    ...
    SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange(lastRow, 3).setValue(completedThreads.length);
    SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange(lastRow, 4).setValue(openThreads.length);
    SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange(lastRow, 5).setValue(postsOwed.length);
  ...
  if(character[0] == last_character){
      ...
      SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange(new_last_row + 1, 3, 1, 3)
      .setHorizontalAlignment("center")
      ...
      var total_completed_thread_values = SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange((new_last_row - ACTIVE_CHARS.length) + 1, 4, new_last_row - (new_last_row - ACTIVE_CHARS.length)).getValues();
      var total_owed_post_values = SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange((new_last_row - ACTIVE_CHARS.length) + 1, 5, new_last_row - (new_last_row - ACTIVE_CHARS.length)).getValues();
      ...
      SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange(lastRow + 1, 4).setValue(total_completed_threads);
      SpreadsheetApp.openById(SHEET_ID).getSheetByName(SHEET_INFORMATION).getRange(lastRow + 1, 5).setValue(total_owed_posts);
    }
